...
import { buildEvent, type ApidepthEvent, type Outcome } from "../src/event.js";
...
describe("buildEvent", () => {
  ...
  it("throws when a required field is missing", () => {
    ...
    expect(() => buildEvent(withoutVendor as ApidepthEvent)).toThrow(
      /missing required fields.*vendor/i
    );
  });
