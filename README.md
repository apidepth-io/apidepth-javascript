...
The package ships two subcommands for setup and connectivity verification.

### `npx apidepth setup`

Interactive wizard that detects your framework (Express, Next.js, or generic), generates the correct initializer snippet, and optionally writes it to disk.
